...
func (mcp *MockCoreProxy) PortStateUpdate(ctx context.Context, deviceID string, pType voltha.Port_PortType,
	portNo uint32, operStatus voltha.OperStatus_OperStatus) error {
	return nil
}