...
##---]  GLOBALS  [---##
##-------------------##
LOCAL_PROTOS ?= $(error LOCAL_PROTOS= is required)
LOCAL_LIB_GO ?= $(error LOCAL_LIB_GO= is required)
...
## -----------------------------------------------------------------------
## Intent: Local Development Helpers
## -----------------------------------------------------------------------
.PHONY: local-protos
...
local-protos:
	...
	$(call banner-enter,$@)
	@echo "** LOCAL_PROTOS: $(LOCAL_PROTOS)"#      # Used for side effects
...
local-lib-go:
	...
	$(call banner-enter,$@)
	@echo "** LOCAL_LIB_GO: $(LOCAL_LIB_GO)"#      # Used for side effects
