...
func (mos MockOnuInterAdapterService) KeepAlive(ctx context.Context, opts ...grpc.CallOption) (onu_inter_adapter_service.OnuInterAdapterService_KeepAliveClient, error) {
	return nil, nil
}
