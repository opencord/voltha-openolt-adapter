...
func (StatMgr *OpenOltStatisticsMgr) PortsStatisticsKpis(ctx context.Context, PortStats *common.PortStatistics, NumPonPorts uint32) {
	...
	*/
	...
	if (IntfID & plt.IntfIDToPortNo(0, voltha.Port_ETHERNET_NNI)) != 0 {
		...
		portNNIStat.RxFrames = PortStats.RxFrames
		portNNIStat.RxUcastFrames = PortStats.RxUcastFrames
		portNNIStat.RxMcastFrames = PortStats.RxMcastFrames
		portNNIStat.RxBcastFrames = PortStats.RxBcastFrames
		portNNIStat.RxCrcErrors = PortStats.RxCrcErrors
		portNNIStat.RxErrorFrames = PortStats.RxErrorFrames
		portNNIStat.RxPacketsDropped = PortStats.RxPacketsDropped
		portNNIStat.TxBytes = PortStats.TxBytes
		portNNIStat.TxFrames = PortStats.TxFrames
		portNNIStat.TxUcastFrames = PortStats.TxUcastFrames
		portNNIStat.TxMcastFrames = PortStats.TxMcastFrames
		portNNIStat.TxBcastFrames = PortStats.TxBcastFrames
		portNNIStat.TxErrorFrames = PortStats.TxErrorFrames
