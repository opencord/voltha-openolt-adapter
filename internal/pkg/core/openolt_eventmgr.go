...
func (em *OpenOltEventMgr) oltCommunicationEvent(ctx context.Context, device *voltha.Device, raisedTs int64) {
	...
	context[events.ContextOltOperState] = device.OperStatus.String()
	context[events.ContextOltAdminState] = device.AdminState.String()
	context[events.ContextOltVendor] = device.Vendor
	context[events.ContextOltConnectState] = device.ConnectStatus.String()
	context[events.ContextOltType] = device.Type
	context[events.ContextOltParentID] = device.ParentId
	context[events.ContextOltParentPortNo] = fmt.Sprintf("%d", device.ParentPortNo)
	context[events.ContextDeviceID] = device.Id
	context[events.ContextOltFirmwareVersion] = device.FirmwareVersion
	context[events.ContextOltHardwareVersion] = device.HardwareVersion
	context[events.ContextOltSerialNumber] = device.SerialNumber
	context[events.ContextOltMacAddress] = device.MacAddress
	de.Context = context
...
func (em *OpenOltEventMgr) oltUpDownIndication(ctx context.Context, oltIndication *oop.OltIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOltOperState] = oltIndication.OperState
...
func (em *OpenOltEventMgr) OnuDiscoveryIndication(ctx context.Context, onuDisc *oop.OnuDiscIndication, oltDeviceID string, onuDeviceID string, OnuID uint32, serialNumber string, raisedTs int64) error {
	...
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuDisc.IntfId), base10)
	context[events.ContextOnuSerialNumber] = serialNumber
	context[events.ContextOnuDeviceID] = onuDeviceID
	context[events.ContextOltPonTechnology] = em.handler.getPonTechnology(onuDisc.IntfId)
	context[events.ContextOltPortLabel], _ = GetportLabel(onuDisc.GetIntfId(), voltha.Port_PON_OLT)
	/* Populating device event body */
	de.Context = context
...
func (em *OpenOltEventMgr) oltLosIndication(ctx context.Context, oltLos *oop.LosIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOltPonIntfID] = strconv.FormatUint(uint64(ponIntdID), base10)
	context[events.ContextOltPortLabel], _ = GetportLabel(oltLos.IntfId, voltha.Port_PON_OLT)
	/* Populating device event body */
	de.Context = context
	de.ResourceId = deviceID
...
func (em *OpenOltEventMgr) oltRebootFailedEvent(ctx context.Context, deviceID string, reason string, raisedTs int64) error {
	de := voltha.DeviceEvent{
		Context:         map[string]string{events.ContextFailureReason: "olt-reboot-failed"},
		ResourceId:      deviceID,
...
func (em *OpenOltEventMgr) onuDisableIndication(ctx context.Context, onui *oop.OnuDisabledIndication, parentDeviceID string, onuDev *OnuDevice, raisedTs int64) error {
	...
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onui.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onui.OnuId), base10)
	context[events.ContextDeviceID] = onuDev.deviceID
	context[events.ContextOnuSerialNumber] = onuDev.serialNumber
	/* Populating device event body */
	de.Context = context
...
func (em *OpenOltEventMgr) onuDyingGaspIndication(ctx context.Context, dgi *oop.DyingGaspIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(dgi.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(dgi.OnuId), base10)
...
func (em *OpenOltEventMgr) onuAlarmIndication(ctx context.Context, onuAlarm *oop.OnuAlarmIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuAlarm.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuAlarm.OnuId), base10)
...
func (em *OpenOltEventMgr) onuActivationIndication(ctx context.Context, eventName string, onuInd *oop.OnuIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuInd.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuInd.OnuId), base10)
	context[events.ContextFailureReason] = onuInd.FailReason.String()
...
func (em *OpenOltEventMgr) onuLossOmciIndication(ctx context.Context, onuLossOmci *oop.OnuLossOfOmciChannelIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuLossOmci.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuLossOmci.OnuId), base10)
...
func (em *OpenOltEventMgr) onuDriftOfWindowIndication(ctx context.Context, onuDriftWindow *oop.OnuDriftOfWindowIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuDriftWindow.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuDriftWindow.OnuId), base10)
	context[events.ContextOnuDrift] = strconv.FormatUint(uint64(onuDriftWindow.Drift), base10)
	context[events.ContextOnuNewEqd] = strconv.FormatUint(uint64(onuDriftWindow.NewEqd), base10)
...
func (em *OpenOltEventMgr) onuSignalDegradeIndication(ctx context.Context, onuSignalDegrade *oop.OnuSignalDegradeIndication, deviceID string, raisedTs int64) error {
	...
	context := make(map[string]string)
	/* Populating event context */
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuSignalDegrade.IntfId), base10)
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuSignalDegrade.OnuId), base10)
	context[events.ContextOnuInverseBitErrorRate] = strconv.FormatUint(uint64(onuSignalDegrade.InverseBitErrorRate), base10)
...
func (em *OpenOltEventMgr) onuSignalsFailIndication(ctx context.Context, onuSignalsFail *oop.OnuSignalsFailureIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuSignalsFail.OnuId), base10)
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuSignalsFail.IntfId), base10)
	context[events.ContextOnuInverseBitErrorRate] = strconv.FormatUint(uint64(onuSignalsFail.InverseBitErrorRate), base10)
	/* Populating device event body */
	de.Context = context
	de.ResourceId = deviceID
...
func (em *OpenOltEventMgr) onuStartupFailedIndication(ctx context.Context, onuStartupFail *oop.OnuStartupFailureIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuStartupFail.OnuId), base10)
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuStartupFail.IntfId), base10)
...
func (em *OpenOltEventMgr) onuLossOfSyncIndication(ctx context.Context, onuLOKI *oop.OnuLossOfKeySyncFailureIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuLOKI.OnuId), base10)
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuLOKI.IntfId), base10)
	/* Populating device event body */
	de.Context = context
	de.ResourceId = deviceID
...
func (em *OpenOltEventMgr) oltIntfOperIndication(ctx context.Context, ifindication *oop.IntfOperIndication, deviceID string, raisedTs int64) {
	...
	/* Populating event context */
	context := map[string]string{events.ContextOltPonIntfOperState: ifindication.GetOperState()}
	/* Populating device event body */
	var de voltha.DeviceEvent
	de.Context = context
	de.ResourceId = deviceID
...
func (em *OpenOltEventMgr) onuDeactivationFailureIndication(ctx context.Context, onuDFI *oop.OnuDeactivationFailureIndication, deviceID string, raisedTs int64) error {
	...
	context[events.ContextOnuOnuID] = strconv.FormatUint(uint64(onuDFI.OnuId), base10)
	context[events.ContextOnuPonIntfID] = strconv.FormatUint(uint64(onuDFI.IntfId), base10)
	/* Populating device event body */
	de.Context = context
	de.ResourceId = deviceID
...
func (em *OpenOltEventMgr) onuRemoteDefectIndication(ctx context.Context, onuID uint32, intfID uint32, rdiCount uint64, status string, deviceID string, raisedTs int64) error {
	...
	context := map[string]string{
		events.ContextOnuOnuID:                      strconv.FormatUint(uint64(onuID), base10),
		events.ContextOnuPonIntfID:                  strconv.FormatUint(uint64(intfID), base10),
		events.ContextOnuRemoteDefectIndicatorCount: strconv.FormatUint(rdiCount, base10),
	}
...
func (em *OpenOltEventMgr) onuLossOfGEMChannelDelineationIndication(ctx context.Context, onuGCD *oop.OnuLossOfGEMChannelDelineationIndication, deviceID string, raisedTs int64) error {
	/* Populating event context */
	context := map[string]string{
		events.ContextOnuOnuID:             strconv.FormatUint(uint64(onuGCD.OnuId), base10),
		events.ContextOnuPonIntfID:         strconv.FormatUint(uint64(onuGCD.IntfId), base10),
		events.ContextOnuDelineationErrors: strconv.FormatUint(uint64(onuGCD.DelineationErrors), base10),
	}
...
func (em *OpenOltEventMgr) onuPhysicalEquipmentErrorIndication(ctx context.Context, onuErr *oop.OnuPhysicalEquipmentErrorIndication, deviceID string, raisedTs int64) error {
	/* Populating event context */
	context := map[string]string{
		events.ContextOnuOnuID:     strconv.FormatUint(uint64(onuErr.OnuId), base10),
		events.ContextOnuPonIntfID: strconv.FormatUint(uint64(onuErr.IntfId), base10),
	}
...
func (em *OpenOltEventMgr) onuLossOfAcknowledgementIndication(ctx context.Context, onuLOA *oop.OnuLossOfAcknowledgementIndication, deviceID string, raisedTs int64) error {
	/* Populating event context */
	context := map[string]string{
		events.ContextOnuOnuID:     strconv.FormatUint(uint64(onuLOA.OnuId), base10),
		events.ContextOnuPonIntfID: strconv.FormatUint(uint64(onuLOA.IntfId), base10),
	}
...
func (em *OpenOltEventMgr) onuDifferentialReachExceededIndication(ctx context.Context, onuDRE *oop.OnuDifferentialReachExceededIndication, deviceID string, raisedTs int64) error {
	/* Populating event context */
	context := map[string]string{
		events.ContextOnuOnuID:                strconv.FormatUint(uint64(onuDRE.OnuId), base10),
		events.ContextOnuPonIntfID:            strconv.FormatUint(uint64(onuDRE.IntfId), base10),
		events.ContextOnuDifferentialDistance: strconv.FormatUint(uint64(onuDRE.Distance), base10),
	}
