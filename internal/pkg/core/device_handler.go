...
func (dh *DeviceHandler) addPort(ctx context.Context, intfID uint32, portType voltha.Port_PortType, state string) error {
	...
	if port, err := dh.coreProxy.GetDevicePort(ctx, dh.device.Id, portNum); err == nil && port.Type == portType {
...
func (dh *DeviceHandler) handleIndication(ctx context.Context, indication *oop.Indication) {
	...
	case *oop.Indication_OltInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_OltInd")
		defer span.Finish()
	...
	case *oop.Indication_IntfInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_IntfInd")
		defer span.Finish()
	...
	case *oop.Indication_IntfOperInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_IntfOperInd")
		defer span.Finish()
	...
	case *oop.Indication_OnuDiscInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_OnuDiscInd")
		defer span.Finish()
	...
	case *oop.Indication_OnuInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_OnuInd")
		defer span.Finish()
	...
	case *oop.Indication_OmciInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_OmciInd")
		defer span.Finish()
	...
	case *oop.Indication_PktInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_PktInd")
		defer span.Finish()
	...
	case *oop.Indication_PortStats:
		span, ctx := log.CreateChildSpan(ctx, "Indication_PortStats")
		defer span.Finish()

		portStats := indication.GetPortStats()
		go dh.portStats.PortStatisticsIndication(ctx, portStats, dh.resourceMgr.DevInfo.GetPonPorts())
	case *oop.Indication_FlowStats:
		span, ctx := log.CreateChildSpan(ctx, "Indication_FlowStats")
		defer span.Finish()
	...
	case *oop.Indication_AlarmInd:
		span, ctx := log.CreateChildSpan(ctx, "Indication_AlarmInd")
		defer span.Finish()
...
func (dh *DeviceHandler) doStateConnected(ctx context.Context) error {
	...
	ports, err := dh.coreProxy.ListDevicePorts(ctx, dh.device.Id)
	if err != nil {
		/*TODO: needs to handle error scenarios */
...
func (dh *DeviceHandler) DisableDevice(ctx context.Context, device *voltha.Device) error {
	...
	if err := dh.coreProxy.PortsStateUpdate(ctx, cloned.Id, ^uint32(1<<voltha.Port_PON_OLT), voltha.OperStatus_UNKNOWN); err != nil {
...
func (dh *DeviceHandler) ReenableDevice(ctx context.Context, device *voltha.Device) error {
	...
	if err := dh.coreProxy.DeviceStateUpdate(ctx, device.Id, device.ConnectStatus, device.OperStatus); err != nil {
