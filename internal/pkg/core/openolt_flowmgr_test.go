...
func TestOpenOltFlowMgr_TestRouteFlowToOnuChannel(t *testing.T) {
	...
	kw_table1_meter1 := make(map[string]uint64)
	kw_table1_meter1["table_id"] = 1
	kw_table1_meter1["meter_id"] = 1
	kw_table1_meter1["write_metadata"] = 0x4000000000 // Tech-Profile-ID 64

	kw_table0_meter1 := make(map[string]uint64)
	kw_table0_meter1["table_id"] = 0
	kw_table0_meter1["meter_id"] = 1
	kw_table0_meter1["write_metadata"] = 0x4000000000 // Tech-Profile-ID 64
