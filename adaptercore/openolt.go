...
func (oo *OpenOLT) Get_ofp_device_info(device *voltha.Device) (*ic.SwitchCapability, error) {
	...
	log.Errorw("Get_ofp_device_info failed-unknown-device", log.Fields{"deviceId": device.Id})
...
func (oo *OpenOLT) Get_ofp_port_info(device *voltha.Device, portNo int64) (*ic.PortCapability, error) {
	...
	log.Errorw("Get_ofp_port_info failed-unknown-device", log.Fields{"deviceId": device.Id})
	return nil, errors.New("unknown-device")
}
...
func (oo *OpenOLT) Disable_device(device *voltha.Device) error {
	...
	log.Errorw("Disable_device failed-unknown-device", log.Fields{"deviceId": device.Id})
...
func (oo *OpenOLT) Reenable_device(device *voltha.Device) error {
	...
	log.Errorw("Reenable_device failed-unknown-device", log.Fields{"deviceId": device.Id})
	return errors.New("unknown-device")
}
...
func (oo *OpenOLT) Reboot_device(device *voltha.Device) error {
	...
	log.Errorw("Reboot_device failed-unknown-device", log.Fields{"deviceId": device.Id})
	return errors.New("unknown-device")
...
func (oo *OpenOLT) Delete_device(device *voltha.Device) error {
	...
	log.Errorw("Delete_device failed-unknown-device", log.Fields{"deviceId": device.Id})
	return errors.New("unknown-device")
}
...
func (oo *OpenOLT) Update_flows_incrementally(device *voltha.Device, flows *openflow_13.FlowChanges, groups *openflow_13.FlowGroupChanges, flowMetadata *voltha.FlowMetadata) error {
	...
	log.Errorw("Update_flows_incrementally failed-unknown-device", log.Fields{"deviceId": device.Id})
	return errors.New("unknown-device")
}
...
func (oo *OpenOLT) Receive_packet_out(deviceID string, egressPortNo int, packet *openflow_13.OfpPacketOut) error {
	...
	log.Errorw("Receive_packet_out failed-unknown-device", log.Fields{"deviceId": deviceID, "egressport": egressPortNo, "packet": packet})
	return errors.New("unknown-device")
}
