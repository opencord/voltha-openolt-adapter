...
func newMockDeviceDeviceHandler() *DeviceHandler {
	...
	return &DeviceHandler{
		...
		// adminState:    tt.fields.adminState,
		device:       device,
		coreProxy:    &mocks.MockCoreProxy{},
		AdapterProxy: &mocks.MockAdapterProxy{},
		// EventProxy:    tt.fields.EventProxy,
		// openOLT:       tt.fields.openOLT,
		// exitChannel:   tt.fields.exitChannel,
		// lockDevice:    tt.fields.lockDevice,
		// Client:        tt.fields.Client,
		// transitionMap: tt.fields.transitionMap,
		// clientCon:     tt.fields.clientCon,
		// flowMgr:       tt.fields.flowMgr,
		// eventMgr:      tt.fields.eventMgr,
		// resourceMgr:   tt.fields.resourceMgr,
		// discOnus:      tt.fields.discOnus,
		// onus:          tt.fields.onus,
		// nniIntfID:     tt.fields.nniIntfID,
	}
}
