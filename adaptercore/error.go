...
// LogError logs the error at the specified log level and then returns the
// error
func LogError(level int, err error, message ...string) error {
	fields := log.Debugw
	plain := log.Debug
	switch level {
	case log.InfoLevel:
	...
	if loggable, ok := err.(Loggable); ok {
		return loggable.LogAt(level, message...)
	}
	if len(message) > 0 {
		fields(strings.Join(message, " "), log.Fields{"error": err})
	} else {
		plain(err)
	}
	return err
...
// Loggable defined functions that can be used to log an object
type Loggable interface {
	Log(...string) error
	LogAt(int, ...string) error
}
...
func (e *ErrAdapter) Log(message ...string) error {
	return e.LogAt(defaultLogAndReturnLevel, message...)
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrAdapter) LogAt(level int, message ...string) error {
	fields := log.Debugw
	switch level {
	case log.InfoLevel:
		fields = log.Infow
...
// Log logs the error at the default level for log and return
func (e *ErrInvalidValue) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrInvalidValue) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
...
// Log logs the error at the default level for log and return
func (e *ErrNotFound) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrNotFound) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
...
// Log logs the error at the default level for log and return
func (e *ErrPersistence) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrPersistence) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
...
// Log logs the error at the default level for log and return
func (e *ErrCommunication) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrCommunication) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
...
// Log logs the error at the default level for log and return
func (e *ErrFlowOp) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrFlowOp) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
...
// Log logs the error at the default level for log and return
func (e *ErrTimeout) Log(message ...string) error {
	_ = e.ErrAdapter.Log(message...)
	return e
}

// LogAt logs the error at the specified level and then returns the error
func (e *ErrTimeout) LogAt(level int, message ...string) error {
	_ = e.ErrAdapter.LogAt(level, message...)
	return e
}
