...
func (dh *DeviceHandler) doStateConnected() error {
	...
	dh.EventFilter.Filters = dh.resourceMgr.GetDeviceFiltersFromKVStore()
...
func (dh *DeviceHandler) SuppressEvent(filter *voltha.EventFilter) error {
	dh.EventFilter.AddRemoveFilters(filter, false)
	return nil
}

func (dh *DeviceHandler) UnsuppressEvent(filter *voltha.EventFilter) error {
	dh.EventFilter.AddRemoveFilters(filter, true)
	return nil
}
